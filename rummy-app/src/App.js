...
let cards = [];
const playersList = [
  {name: 'Player 1', hand: [], startingPosition: false, currentPlayer: false},
...
export function TakeCard(drawnCard, round, playerCount) {
  // current player draws a card
  let i = 0;
  // for (i; i < playerCount; i++){
  //   if(playersList[i].currentPlayer){
  //     console.log(drawnCard)
  //     let takenCard = [drawnCard]
  //     console.log(takenCard)
  //     playersList[i].hand.splice(0, 0, takenCard)
  //   }
  // }
...
function EndTurn() {
  // end current players turn and move to the next player
  // if current player can go out, the run last card phase, else move to next player.
